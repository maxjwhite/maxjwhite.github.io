...
<p style="margin-bottom:0;"><strong>LSTM</strong></p>
<div style="text-align: justify;">
...
<p style="margin-bottom:0;"><strong>KMeans</strong></p>
<div style="text-align: justify;">
...
<p style="margin-bottom:0;"><strong>RandomForest</strong></p>
<div style="text-align: justify;">
...
<div style="display: flex; justify-content: center; gap: 40px;">
  ...
  <div style="text-align: center; width: 500px;">
    <p style="margin-bottom:0;"><strong>Regression</strong></p>
    <img src="/image/eval_reg.png" alt="Regression Evaluation" width="500">
  </div>

  <div style="text-align: center; width: 500px;">
    <p style="margin-bottom:0;"><strong>LSTM</strong></p>
    <img src="/image/eval_lstm.png" alt="LSTM Evaluation" width="500">
  </div>
...
<div style="display: flex; justify-content: center; gap: 40px;">
  ...
  <div style="text-align: center; width: 500px;">
    <p style="margin-bottom:0;"><strong>Before</strong></p>
    <img src="/image/before_pivot.png" alt="Before Pivot" width="500">
  </div>

  <div style="text-align: center; width: 500px;">
    <p style="margin-bottom:0;"><strong>After</strong></p>
    <img src="/image/after_pivot.png" alt="After Pivot" width="500">
  </div>
